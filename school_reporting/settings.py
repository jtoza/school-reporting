"""
Django settings for school_reporting project.
"""
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-your-default-dev-secret-key-change-this-in-production')
